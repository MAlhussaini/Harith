...
def add_cors_headers(response):
    # لتسهيل الاتصال من Harith Push ومن أي متصفح في الشبكة
...
@app.route("/")
def root():
    # تحويل مباشر للـ dashboard الإداري
...
# =============== Dashboard الإداري للتحكم بالبرامج ===============
...
<body>
  <div class="card">
    ...
    <p class="info">
      من هنا تتحكم في برامج الري (التايمرات).<br>
      صفحة Harith Push للجوال متوفرة على الرابط:
      <a href="/harith_push" target="_blank">/harith_push</a>
    </p>
    <p class="small-muted">
      Harith Push يمكن تثبيته كتطبيق PWA من الجوال (إضافة إلى الشاشة الرئيسية).
    </p>
  </div>
...
# =============== Harith Push PWA للجوال ===============

@app.route("/harith_push")
def harith_push():
    # يستخدم ملف template مستقل
